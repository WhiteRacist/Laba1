...
<body>
    ...
    <div class="home-slider">
        <div class="home-slider--wrapper">
            <div>
                <div class="home-slider--wrapper__inner" style="background-image: url('../../../../../../OneDrive/Рабочий стол/assets/img/slider.jpg')">
                    <div class="container">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-7 col-sm-12 col-xs-12">
                        ...
                        <a href="about.jsp" class="button">Browse Our Work</a>
                    </div>
                </div>
            </div>
        </section>
                ...
                <div class="case-study--sliders">
                    ...
                    <div class="case-study--right">
                        <div class="case-study--right__imageslider">
                            <div>
                                <img src="../../../../../../OneDrive/Рабочий%20стол/assets/img/case.jpg" alt="" />
                            </div>
                            <div>
                                <img src="../../../../../../OneDrive/Рабочий%20стол/assets/img/case.jpg" alt="" />
                            </div>
                ...
                <div class="partners--container">
                    <div class="partners--item">
                        <div class="partners--item__image">
                            <img src="../../../../../../OneDrive/Рабочий%20стол/assets/img/partner1.png" alt="">
                        </div>
                    </div>
                    <div class="partners--item">
                        <div class="partners--item__image">
